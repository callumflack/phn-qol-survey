			...
			<div>
				...
				<main className="o-content" role="main">
					<div className="o-container">
						...
						<p className="u-textMd">You are about to complete the World Health Organization’s Quality of Life survey, which assesses an individual's perception of their quality of life in the context of the culture and values in which they live. This survey will not record any personally identifiable information.</p>
